    ...
    public String getConteudoTemplate(Map<String, Object> model) {
        ...
        try {
            content.append(FreeMarkerTemplateUtils.processTemplateIntoString(
                    fmConfiguration.getTemplate("email-recuperacao-codigo.flth"), model)); // Processa o template com os modelos fornecidos
        } catch (Exception e) {
            e.printStackTrace();
        }
        return content.toString(); // Retorna uma string vazia em caso de erro
    }
}